...
public class CircleProgress extends View {
    ...
    private void initPaint(Context context) {
        ...
        circlePaint.setColor(Color.parseColor("#013E5A"));
    ...
    private void drawWavePath(Canvas canvas) {
        ...
        LinearGradient linearGradient =new LinearGradient(0,0,0,450, Color.BLUE,Color.parseColor("#FF0000"), Shader.TileMode.MIRROR);
    ...
    private void drawProcessText(Canvas canvas) {
        ...
        int baseline = (targetRect.bottom + targetRect.top - fontMetrics.bottom - fontMetrics.top) / 3*2;
